...
public class Tiles implements State {
	...
	protected final int[] tiles; // tiles[i*width + j] represents number in (i,j) tile, 0 if empty 
	...
	public boolean equals(Object that) {
		...
		return width == other.width && 
			   emptyTileColumn == other.emptyTileColumn &&
			   emptyTileRow == other.emptyTileRow && 
